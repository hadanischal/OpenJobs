...
"${INPUT_DIR}/NetworkLayer/Services/JobsNetworkHandler.swift" \
"${INPUT_DIR}/CoreDataManager/CoreDataManagerHandler.swift" \
"${INPUT_DIR}/ViewModel/JobsListRepository.swift"
